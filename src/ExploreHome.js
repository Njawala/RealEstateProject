...
export default function ExploreHome() {
    return (
     ...
     <MDBRow className='row-cols-1 row-cols-md-4 g-4' style={{marginTop:'4%'}}>
      <MDBCol>
        <MDBCard className='h-100'>
          <MDBCardImage
            src={process.env.PUBLIC_URL+"images/Explore/House2.jpg"}
            height="210px"
            alt='House2'
            position='top'
          />
          ...
          <MDBCardFooter>
            <small className='text-muted'>Posted 30min ago</small>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          <MDBCardImage
            src={process.env.PUBLIC_URL+"images/Explore/House3.jpg"}
            height="210px"
            alt='House3'
            position='top'
          />
          <MDBCardBody>
          <MDBCardText style={{background:'linear-gradient( #00b4db,#0083b0 )',color:'white'}}>Listing For Rent</MDBCardText>
            <MDBCardTitle>MK 300, 000 </MDBCardTitle>
            <MDBCardText>
              <b>2</b>Beds | <b>2</b>baths | BrickFenced<br></br>
              Lilongwe, Area 47
          ...
          <MDBCardFooter>
            <small className='text-muted'>Posted 1 hr ago</small>
          </MDBCardFooter>
        </MDBCard>
      </MDBCol>
      <MDBCol>
        <MDBCard className='h-100'>
          <MDBCardImage
            src={process.env.PUBLIC_URL+"images/Explore/House4.jpg"}
            height="210px"
            alt='House4'
            position='top'
          />
